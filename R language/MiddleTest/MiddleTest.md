...
```r
v1 <- c(1, 2, 3, 4, 5)
length(v1)                      # 5 / 백터 길이 확인
append(v1, 6)                   # [1] 1 2 3 4 5 6 / 백터 요소 추가
append(v1, c(11,12) after = 3)  # [1] 1 2 3 11 12 4 5 / 백터 원하는 위치에 원하는 숫자 추가
v1[1:(length(v1)-2)]            # [1] 1 2 3 / 백터 뒤에 삭제
setdiff(v1, c(2,3))             # [1] 1 4 5 / 차집합
intersect(v1, c(2,3))           # [1] 2 3 / 교집합
union(v1, c(2,3))	        # [1] 1 2 3 4 5 / 합집합
rep(1:3, each=2)                # [1] 1 1 2 2 3 3 / 백터 반복 생성
```
